...
Revision ID: 010144366d4b
Revises: 
Create Date: 2022-01-27 14:09:46.793409
...
def upgrade():
    ...
    sa.Column('delete_mark', sa.String(length=10), nullable=True),
    ...
    sa.Column('id_card', sa.String(length=80), nullable=True),
