...
from .views import UserRegisterView, UserActiveView, UserActiveGetView, UserLoginView, UserLogoutView, UserCenterView, UserCartView, UserOrderView, UserAddressView, UserAlterPwdView
app_name = 'user'
urlpatterns = [
